...
(function (angular) {
	...
	var PainelAdminDialogController = (function () {
		function PainelAdminDialogController($mdDialog, locals) {
			...
			self.viagem.passageiros = JSON.parse(self.viagem.passageiros) || self.viagem.passageiros;
			self.viagem.veiculo = JSON.parse(self.viagem.veiculo) || self.viagem.veiculo;
